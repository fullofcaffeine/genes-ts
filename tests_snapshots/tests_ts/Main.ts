...
export class Main {
	static main(): void {
		let f: Foo = new Foo(1);
		console.log("tests_ts/src/Main.hx:9:",f.add(2));
		AsyncFoo.demo().then(function (v: number) {
			console.log("tests_ts/src/Main.hx:10:",v);
		});
		console.log("tests_ts/src/Main.hx:11:",Placeholder.demo());
		console.log("tests_ts/src/Main.hx:12:",EnumAbstract.demo());
	}
