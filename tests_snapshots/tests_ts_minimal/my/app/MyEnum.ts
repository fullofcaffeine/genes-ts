...
export declare namespace MyEnum {
	export const __constructs__: any[];
	export const __empty_constructs__: any[];
...
Object.assign(MyEnum, {
	...
	B: Object.assign((value: any) => ({_hx_index: 1, __enum__: "my.app.MyEnum", "value": value}), {_hx_name: "B", __params__: ["value"]})
});
