...
function assertHaxeHxxNegatives(): void {
  ...
  const cases: ReadonlyArray<readonly [string, string, string?]> = [
    ...
    ["hxx_negative_element_text_child", "GTS-HXX-CHILD-003"],
    ["hxx_negative_element_multiple_children", "GTS-HXX-CHILD-003"],
    ["hxx_negative_element_missing_child", "GTS-HXX-CHILD-002"],
