...
read-only TypeScript assertion, while ordinary compound assignment targets
...
Haxe/JavaScript's accepted `null` coercion; the separate result read still
follows the ordinary nullable-array contract.
