...
The provider subpaths require the package's reviewed Node 22.22+ or Node 24.10+
...
3. a fixed adapter loads pinned `postcss-modules` only in a fresh admitted
   child, and its measured copied package closure supplies `processorIntegrity`;
