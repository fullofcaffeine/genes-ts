...
2. Before Haxe DCE can erase source-level information, `PublicSurface`,
   ...
   and freezes their literal sets before DCE; the ordinary type printer remains
   the single recursive renderer. Directive capture adds no roots or dependency
   edges.
