...
export class App {
	static Component(): JSX.Element {
		...
		let tmp: JSX.Element = React__genes_jsx.createElement("h1", ({style: {"margin": "0"}} satisfies (React__genes_jsx.ComponentPropsWithoutRef<"h1"> & React__genes_jsx.Attributes & { [K in `data-${string}`]?: string | number | boolean | null | undefined } & { [K in `aria-${string}`]?: string | number | boolean | null | undefined })), "Todoapp");
		let tmp1: JSX.Element = React__genes_jsx.createElement(Link, ({to: "/", style: {"textDecoration": "none"}, children: "Home"} satisfies (React__genes_jsx.ComponentPropsWithoutRef<typeof Link> & React__genes_jsx.Attributes & { [K in `data-${string}`]?: string | number | boolean | null | undefined } & { [K in `aria-${string}`]?: string | number | boolean | null | undefined })));
		let tmp2: JSX.Element = React__genes_jsx.createElement("nav", null, tmp1);
		let tmp3: JSX.Element = React__genes_jsx.createElement("header", ({style: {"display": "flex", "justifyContent": "space-between", "alignItems": "center"}} satisfies (React__genes_jsx.ComponentPropsWithoutRef<"header"> & React__genes_jsx.Attributes & { [K in `data-${string}`]?: string | number | boolean | null | undefined } & { [K in `aria-${string}`]?: string | number | boolean | null | undefined })), tmp, tmp2);
		let tmp4: JSX.Element = React__genes_jsx.createElement("hr", null);
		let tmp5: JSX.Element = React__genes_jsx.createElement(Route, ({path: "/", element: React__genes_jsx.createElement(TodoListComponent, null)} satisfies (React__genes_jsx.ComponentPropsWithoutRef<typeof Route> & React__genes_jsx.Attributes & { [K in `data-${string}`]?: string | number | boolean | null | undefined } & { [K in `aria-${string}`]?: string | number | boolean | null | undefined })));
		...
		let tmp7: JSX.Element = React__genes_jsx.createElement(Routes, ({children: [tmp5, tmp6]} satisfies (React__genes_jsx.ComponentPropsWithoutRef<typeof Routes> & React__genes_jsx.Attributes & { [K in `data-${string}`]?: string | number | boolean | null | undefined } & { [K in `aria-${string}`]?: string | number | boolean | null | undefined })));
		...
		return React__genes_jsx.createElement(BrowserRouter, ({children: tmp8} satisfies (React__genes_jsx.ComponentPropsWithoutRef<typeof BrowserRouter> & React__genes_jsx.Attributes & { [K in `data-${string}`]?: string | number | boolean | null | undefined } & { [K in `aria-${string}`]?: string | number | boolean | null | undefined })));
	}
